---
title: "Stack Canary Bypass via Format String Leak"
date: 2022-03-14
category: "stack-canary"
difficulty: "advanced"
source: "INE"
tags: [INE, advanced, stack-canary, format-string, pwntools]
excerpt: "Leaking the stack canary through a format-string information disclosure, then overwriting the return address while keeping the canary intact."
cover: "/writeups/stack-canary-bypass/canary_img1.png"
draft: false
---
...
![canary_img1.png](/writeups/stack-canary-bypass/canary_img1.png)
...
![canary_img2.png](/writeups/stack-canary-bypass/canary_img2.png)
...
![canary_img3.png](/writeups/stack-canary-bypass/canary_img3.png)

In \<Vuln+86\>, the canary move \[ebp-0xc\] to eax. So we can see what the value is

![canary_img4.png](/writeups/stack-canary-bypass/canary_img4.png)
...
![canary_img5.png](/writeups/stack-canary-bypass/canary_img5.png)

![canary_img6.png](/writeups/stack-canary-bypass/canary_img6.png)
...
![canary_img7.png](/writeups/stack-canary-bypass/canary_img7.png)

![canary_img8.png](/writeups/stack-canary-bypass/canary_img8.png)

Then, continue the program, the program will be crashed and return address, get the offset.

![canary_img9.png](/writeups/stack-canary-bypass/canary_img9.png)
...
![canary_img10.png](/writeups/stack-canary-bypass/canary_img10.png)

![canary_img11.png](/writeups/stack-canary-bypass/canary_img11.png)
...
![canary_img12.png](/writeups/stack-canary-bypass/canary_img12.png)
...
![canary_img13.png](/writeups/stack-canary-bypass/canary_img13.png)
